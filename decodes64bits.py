...
registers = ["ax", "bx", "cx","dx", "si", "di","sp", "[bx]", "[si]", "[di]","[sp]","bp","[bp]","0x0","ah","al", "bh","bl", "ch","cl", "dh","dl","[0x0]","eax", "ebx", "ecx", "esi", "edi", "ebp", "esp", "[ebx]", "[esi]", "[edi]", "[ebp]", "[esp]" ,"rax", "rbx", "rcx", "rsi", "rdi", "rbp", "rsp", "[rbx]", "[rsi]", "[rdi]", "[rbp]", "[rsp]" ,"ds","es", "cs","gs" "ss"]
